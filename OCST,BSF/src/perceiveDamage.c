...
///// model 26-31 in the manuscript /////

extern int** interdiction, ** fortification, ** auxiliaryInterdiction, ** interdictionperceived;
extern int Fbudget, Ibudget, CoverConstraint;
...
double perceivedDamage(CONFIGURATION param, INSTANCE data, RESULTS* results) {
	...
	ub[index1] = objSample[0] + Ibudget * M;
	index1++;
	...
	CPXsetdblparam(envPD, CPX_PARAM_EPGAP, 0.0001); // e-optimal solution (%gap)
