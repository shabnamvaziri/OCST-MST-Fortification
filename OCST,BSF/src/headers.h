...
//struct timeval startSampling, startTotal, endBSF, startwhile, endwhile, startnew, endnew, finish, start, init_time_Linux;
//struct timeval endSampling, endTotal, endincumbent, stopsample, startsample;
